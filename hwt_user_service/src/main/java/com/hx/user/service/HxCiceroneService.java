...
//    HxCiceroneInfoVo judge_is_cicerone(Long user_id);
	 ...
	 * @param banner 
	 */
	void update_about_cover(String about, String cover, Long user_id, String banner);
	 ...
	 * @return
	 */
	String cicerone_work_time(Long cicerone_user_id);
	 ...
	 * 月份的价格查询
	 * @param user_id
	 * @param time_str		如2018-09
	 * @return
	 */
	List<HwPriceVo> price_mouth_query(Long user_id, String time_str);
	 ...
	 * @param workTime
	 */
	void price_delete(Long user_id, String workTime) throws Exception;
	 ...
	 * @return
	 */
	void price_insert_update(Long user_id, String workTime, BigDecimal adult_price) throws Exception;
