...
import com.hwt.domain.entity.mg.scenic.vo.TravelIndexNewVo;
...
public class IndexController {
    ...
    @ApiImplicitParams({
    		...
    		@ApiImplicitParam(name = "area_code", value = "区号", dataType = "string",paramType = "query"),
            @ApiImplicitParam(name = "searchKey", value = "查询条件", dataType = "string",paramType = "query"),
    ...
    public ResultEntity search(String area_code,String searchKey,@RequestParam(name = "type",defaultValue="0") Integer type,
    		
                                    @RequestParam(name = "pageIndex",defaultValue = "1")Integer pageIndex,
                                    @RequestParam(name = "pageSize",defaultValue = "10")Integer pageSize){
        List<Map<String,Object>> list = indexService.search(searchKey,type,pageIndex,pageSize,area_code);
     ...
     * 首页改
     */
    @ApiOperation(value = "首页改" , notes = "首页改", response = TravelIndexNewVo.class)
    @ApiImplicitParams({
    	@ApiImplicitParam(name = "area_code", value = "区号", dataType = "string",paramType = "query"),
    	@ApiImplicitParam(name = "pageIndex", value = "开始页   默认1", dataType = "string",required = true,paramType = "query"),
    })
    @PostMapping("/hw/indexNew")
    public ResultEntity indexNew(String area_code, @RequestParam(name = "pageIndex",defaultValue = "1")Integer pageIndex){
    	Map<String, Object> map = indexService.indexNew(area_code,pageIndex);
        return new ResultEntity(map);
    }
}
