...
//    }
    ...
    *//**
    ...
    @ApiImplicitParams({
    	...
    	@ApiImplicitParam(name = "about", value = "关于自己", dataType = "string",paramType = "query"),
    	@ApiImplicitParam(name = "cover", value = "封面", dataType = "string",paramType = "query"),
    	@ApiImplicitParam(name = "banner", value = "轮播图", dataType = "string",paramType = "query"),
    })
    @ApiResponses(value = {
    		@ApiResponse(code = 200, message = "成功!")
    })
    ...
    public ResultEntity update_about(String about,String cover,String banner,String token){
    	LoginVo loginVo = BaseUtil.getLoginVo(token);
    	hxCiceroneService.update_about_cover(about,cover,loginVo.getUser_id(),banner);
    	return  new ResultEntity();
    }
	  ...
	  * 获取导游的接单日期
	  */
	 @ApiOperation(value = "获取导游的接单日期" , notes = "获取导游的接单日期", response = String.class)
	 @ApiImplicitParams({
	 		@ApiImplicitParam(name = "token", value = "用户验证TOKEN - Y", dataType = "string",required = true,paramType = "query"),
	         @ApiImplicitParam(name = "cicerone_user_id", value = "导游的用户id", dataType = "string",required = true,paramType = "query"),
	 })
	 @ValidateParam(field={"token","cicerone_user_id"}, checkedType = CheckedType.TOKEN)
		@PostMapping("/cicerone/cicerone_work_time")
	 public ResultEntity cicerone_work_time(Long cicerone_user_id){
	 	String work_time  = hxCiceroneService.cicerone_work_time(cicerone_user_id);
	 	return new ResultEntity(work_time);
	 }
	  ...
	  * 删除价格
	  */
	 @ApiOperation(value = " 删除价格" , notes = " 删除价格", response = String.class)
	 @ApiImplicitParams({
	 		@ApiImplicitParam(name = "token", value = "用户验证TOKEN - Y", dataType = "string",required = true,paramType = "query"),
	        @ApiImplicitParam(name = "workTime", value = "接单日期 如 2018-09-06多个用,隔开  ", dataType = "string",required = true,paramType = "query"),
	 })
	 @ValidateParam(field={"token","workTime"}, checkedType = CheckedType.TOKEN)
	 @PostMapping("/cicerone/price_delete")
	 public ResultEntity price_delete(String token, String workTime) throws Exception {
		LoginVo loginVo = BaseUtil.getLoginVo(token);
		
		hxCiceroneService.price_delete(loginVo.getUser_id(),workTime);
	 	return new ResultEntity();
	 }
	  ...
	  * 月份的价格查询
	  */
	 @ApiOperation(value = "月份的价格查询" , notes = "月份的价格查询", response = HwPriceVo.class)
	 @ApiImplicitParams({
	 		@ApiImplicitParam(name = "token", value = "用户验证TOKEN - Y", dataType = "string",required = true,paramType = "query"),
	        @ApiImplicitParam(name = "cicerone_user_id", value = "导游的用户id ", dataType = "string",paramType = "query"),
	        @ApiImplicitParam(name = "time_str", value = " 如2018-09", dataType = "string",paramType = "query"),
	 })
	 @ValidateParam(field={"token"}, checkedType = CheckedType.TOKEN)
	 @PostMapping("/cicerone/price_mouth_query")
	 public ResultEntity price_mouth_query(String token, Long cicerone_user_id,String time_str) throws Exception {
		LoginVo loginVo = BaseUtil.getLoginVo(token);
		Long user_id = loginVo.getUser_id();
		if (cicerone_user_id!=null){
			user_id = cicerone_user_id;
		}
		List<HwPriceVo> list = hxCiceroneService.price_mouth_query(user_id,time_str);
	  ...
	  * 修改添加价格
	  */
	 @ApiOperation(value = "修改添加价格" , notes = "修改添加价格", response = HwPriceVo.class)
	 @ApiImplicitParams({
	 		@ApiImplicitParam(name = "token", value = "用户验证TOKEN - Y", dataType = "string",required = true,paramType = "query"),
	         @ApiImplicitParam(name = "workTime", value = "接单日期 如 2018-09-06多个用,隔开  ", dataType = "string",required = true,paramType = "query"),
	         @ApiImplicitParam(name = "adult_price", value = "成人价格   ", dataType = "string",required = true,paramType = "query"),
	 })
	 @ValidateParam(field={"token","workTime"}, checkedType = CheckedType.TOKEN)
		@PostMapping("/cicerone/price_insert_update")
	 public ResultEntity price_insert_update(String token, String workTime,BigDecimal adult_price) throws Exception {
		LoginVo loginVo = BaseUtil.getLoginVo(token);
	 	hxCiceroneService.price_insert_update(loginVo.getUser_id(),workTime,adult_price);
	 	return new ResultEntity();
	 }
