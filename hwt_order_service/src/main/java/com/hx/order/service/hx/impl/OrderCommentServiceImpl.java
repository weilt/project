...
public class OrderCommentServiceImpl implements OrderCommentService{
	...
	public HwOrderComment insert(Long user_id, Long order_id, Long parent_comment_id, Long parent_user_id,
		...
		if (hwOrder.getCicerone_id()!=0){
	    	...
	    	updateMap.put("comment_count", (ObjectHelper.isEmpty(findOne2.get("comment_count"))?0:(int)findOne2.get("comment_count"))+1);
	    	updateMap.put("comment_score", (ObjectHelper.isEmpty(findOne2.get("comment_score"))?0F:Float.parseFloat(findOne2.get("comment_score").toString()))+score);
			...
			findOne.put("total_comment_num", (ObjectHelper.isEmpty(findOne.get("total_comment_num"))?0:(int)findOne.get("total_comment_num"))+1);
			findOne.put("total_service_score", (ObjectHelper.isEmpty(findOne.get("total_service_score"))?0:(int)findOne.get("total_service_score"))+service_score);
			findOne.put("total_trip_score", (ObjectHelper.isEmpty(findOne.get("total_trip_score"))?0:(int)findOne.get("total_trip_score"))+trip_score);
			findOne.put("total_match_score", (ObjectHelper.isEmpty(findOne.get("total_match_score"))?0:(int)findOne.get("total_match_score"))+match_score);
			findOne.put("total_score", (ObjectHelper.isEmpty(findOne.get("total_score"))?0D:(Double)findOne.get("total_score"))+score);
	        ...
	        Map<String, Object> updateMap = new HashMap<>();
	    	updateMap.put("comment_count", (ObjectHelper.isEmpty(findOne2.get("comment_count"))?0:(int)findOne2.get("comment_count"))+1);
	    	updateMap.put("comment_score", (ObjectHelper.isEmpty(findOne2.get("comment_score"))?0F:(float)findOne2.get("comment_score"))+score);
