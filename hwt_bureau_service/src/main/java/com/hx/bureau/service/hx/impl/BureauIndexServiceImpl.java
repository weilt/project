...
public class BureauIndexServiceImpl implements BureauIndexService{
	...
	public Map<String, Object> query_index(Long bureau_id) {
		...
		//本月订单总数
		Long this_month_order_total = hwOrderMapper.query_today_order_by_bureau_id_this_month(bureau_id,getmonth());
		map.put("this_month_order_total", this_month_order_total);
		//本周订单总数
		Long this_week_order_total = hwOrderMapper.query_today_order_by_bureau_id_this_week(bureau_id,getweek());
		map.put("this_week_order_total", this_week_order_total);
		return map;
	}
