...
//		//查询销售总额
//		BigDecimal sole_tatol = hwOrderMapper.query_sole_tatol_bureau(bureau_id);
//		map.put("sole_tatol", sole_tatol);
//		//查询违约金额
//		BigDecimal bad_payment = hxUserWalletBillMapper.query_bad_payment_tatol_bureau(bureau_id);
//		map.put("bad_payment", bad_payment);
//		//查询已提现金额
//		BigDecimal get_payment = hxUserWalletBillMapper.query_get_payment_tatol_bureau(bureau_id);
		return map;
	}
