...
public class NtesImServiceImpl implements ImService {
	...
	@Override
	public String sendMsgPTOPExt(String from, String ope, String to, int type, String body, String ext)
			throws Exception {
		// TODO Auto-generated method stub
		return NtesCommon.sendMsg(from, ope, to, type, body, false, null, null, null, null, ext, null, null, null, null, null, null);
	}
