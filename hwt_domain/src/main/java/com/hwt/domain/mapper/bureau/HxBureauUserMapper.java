...
public interface HxBureauUserMapper {
	 ...
	 * @return
	 */
    @Select("select bureau_user_id, bureau_user_account, pwd_salt, password, bureau_id, bureau_role_id, "
    +"create_time, im_id, im_token, im_token_time, is_legal, is_delete, phone, real_name, "
    +"description, remarks from hx_bureau_user where bureau_user_account = #{bureau_user_account}")
