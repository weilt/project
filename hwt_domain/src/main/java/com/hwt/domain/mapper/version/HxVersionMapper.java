...
public interface HxVersionMapper  {
	 ...
	 * @return
	 */
	@Select("select id,version_name,version_number,android_or_ios,"
			+ "minimun,is_not_minimum,versions_url,remarks,create_time from hx_version")
	 ...
	 */
	@Select("select id,version_name,version_number,android_or_ios,"
			+ "minimun,is_not_minimum,versions_url,remarks,create_time  from hx_version where id=#{id}")
	 ...
	 */
	@Select("select id,version_name,version_number,android_or_ios,"
			+ "minimun,is_not_minimum,versions_url,remarks,create_time, version_instructions  from hx_version where android_or_ios=#{android_or_ios} ORDER BY id DESC LIMIT 0,1")
