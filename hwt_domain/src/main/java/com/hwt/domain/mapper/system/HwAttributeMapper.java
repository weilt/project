...
public interface HwAttributeMapper {
	 ...
	 * @return
	 */
	@Select("select attribute_id, attribute_name, attribute_key, attribute_dec, is_hide, update_time, "
   +" create_time from hw_attribute where attribute_key = #{attribute_key}")
