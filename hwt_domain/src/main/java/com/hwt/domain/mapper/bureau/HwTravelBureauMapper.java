...
public interface HwTravelBureauMapper {
	 ...
	 * @return
	 */
    @Select("select   bureau_id, bureau_account, password, pwd_salt, company_name, license_no, legal_person, "
	   ...
	   +" bank_name from hw_travel_bureau where license_no = #{license_no}  ")
	 ...
	 */
	 @Select("select  bureau_id, bureau_account, password, pwd_salt, company_name, license_no, legal_person, "
	    ...
	    +"contacts_emil, license_url, busine_licen_url, duty_policy_url, identity_positive, "
	    +"identity_negative, reason, state, remark, create_time, examine_time, bureau_bank_account, "
	   +" bank_name from hw_travel_bureau ")
	 ...
	 */
	 @Select("select  bureau_id, bureau_account, password, pwd_salt, company_name, license_no, legal_person, "
	    ...
	    +"contacts_emil, license_url, busine_licen_url, duty_policy_url, identity_positive, "
	    +"identity_negative, reason, state, remark, create_time, examine_time, bureau_bank_account, "
	   +" bank_name from hw_travel_bureau where legal_person_phome = #{legal_person_phome}  ")
