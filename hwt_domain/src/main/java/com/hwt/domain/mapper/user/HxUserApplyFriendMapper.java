...
public interface HxUserApplyFriendMapper{
	 ...
	 * @return
	 */
	@Select("select apply_user_id,apply_friend_id,friend_remark,remarks,friend_see_me_space,"
			+ " apply_state,recent_time from hx_user_apply_friend where apply_user_id = #{userId} and apply_friend_id = #{friendId}")
