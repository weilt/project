...
public interface HxBureauModuleMapper {
	 ...
	 * @return
	 */
	@Select("SELECT bureau_module_id,name,url,parent_id,module_image,is_hide  from hx_bureau_module where bureau_module_id in (select b.bureau_module_id from hx_bureau_module_user b where b.bureau_user_id= #{bureau_user_id}) order by sort")
	 ...
	 * @return
	 */
	@Select("SELECT bureau_module_id,name,url,parent_id,module_image ,is_hide from hx_bureau_module")
