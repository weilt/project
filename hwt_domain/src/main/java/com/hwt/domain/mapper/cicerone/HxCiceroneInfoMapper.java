...
public interface HxCiceroneInfoMapper {
	 ...
	 * @return
	 */
	@Select("select user_id, real_name, sex, birthday, cover, identity_no, identity_positive, identity_negative, "
    ...
    +"is_open, is_hide from hx_cicerone_info")
	 ...
	 * @return
	 */
	@Select("select  a.user_id, a.real_name, a.sex, a.birthday, a.cover, a.identity_no, a.identity_positive, a.identity_negative, "
    +"a.identity_hold, a.service_area_city, a.service_area_city_name, a.work_status, a.autograph, "
    +"a.phone, a.tag, a.service_count, a.score_num, a.score, a.collect, a.confirm, a.status, a.reason, a.everyday_price, "
    +"a.create_time, a.examine_time, a.is_reserved_num, a.refuse_num, a.is_canceled_num, a.cicerone_type, "
    +"a.is_open, a.is_hide ,b.account,b.account_phone  from hx_cicerone_info a, hx_user b where a.user_id = #{user_id} and a.user_id = b.user_id")
...
//	HxCiceroneInfoVo queryHxCiceroneInfoVoByUserId(@Param("user_id")Long user_id);
	 ...
	 * @return
	 */
	@Select("select a.* ,b.user_icon from hx_cicerone_info a , hx_user_info b where a.user_id = #{user_id} and b.user_id = a.user_id ")
