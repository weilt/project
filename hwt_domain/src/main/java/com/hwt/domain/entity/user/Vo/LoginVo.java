...
public class LoginVo implements Serializable{
	...
	public LoginVo(Long user_id, String account, String account_phone, String im_id, String im_token,
			String referrer_account, Date recently_login_time, String recently_login_ip, String token,String user_icon,String friend_circle_cover,String user_autograph) {
		super();
