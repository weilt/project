 ...
 * @author 
 */
@ApiModel(value="订单基本信息")
public class HwOrderVo implements Serializable {

    /**
     * 用户APP账号名称
     */
    @ApiModelProperty(value = "用户APP账号名称" )
     ...
     * 保险id  0 为没有保险
     */
	@ApiModelProperty(value = "保险id  0 为没有保险")
    private Long insurance_id;

    /**
     * 优惠券id  0 为没有优惠券
     */
	@ApiModelProperty(value = " 优惠券id  0 为没有优惠券" )
