...
public class ScenicSpotVO implements Serializable {
    ...
    @ApiModelProperty(value = "来源景点URL")
    ...
    @ApiModelProperty(value = "轮播视频  为空则没有视频")
    private String banner_videos; //轮播视频
    
    @ApiModelProperty(value = "封面类型 1-图片 2-视频")
	...
	public String getBanner_videos() {
		return banner_videos;
	}

	public void setBanner_videos(String banner_videos) {
		this.banner_videos = banner_videos;
	}
