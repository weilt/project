...
import com.hx.bureau.aliyun.file.service.OSSService;
...
public class Upload_jsonController {
	...
	public String upload_jsonUserImageController(String token,HttpServletRequest request
		...
		String url = "bureau/line/"+UUIDHelper.createUUId()+uploadFile.getOriginalFilename().substring(uploadFile.getOriginalFilename().lastIndexOf('.'));
		try {
