...
//        },
        ...
        {title:'操作', customHtml:
        	...
        	function(rowData,index){
				...
				html += '<a onclick="bill_info('+rowData.bill_id+',\'bureau/wallet/bill-info\',\'明细详情\')" href="javascript:void(0);" class="btn btn-sm btn-outline-primary mg-r-5 pd-b-5"><div><i class="fa fa-pencil"></i>查看详情</div></a>';
