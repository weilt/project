...
$(function(){
	...
	_settings.ro_columns =  [
        ...
        {filed:'line_name', 
        	customHtml : function(rowData,index){
        		var openingHours = rowData.line_name==null?"":rowData.line_name;
...
//        },
        ...
        {title:'操作', customHtml:
        	...
        	function(rowData,index){
	        	var html = '';
				html += '<a onclick="line_preview('+rowData.line_id+',\'adminHx/cicerone/info\',\'线路预览--（'+rowData.line_name+'）\')" href="javascript:void(0);" class="btn btn-sm btn-outline-primary mg-r-5 pd-b-5"><div><i class="fa fa-pencil"></i>线路预览</div></a>';
				...
				if (rowData.is_hide==1){
					html += '<a onclick="deleteAndRecoveryById(0,'+rowData.line_id+',\'bureau/line/delete\',\'确定要上架线路---'+rowData.line_name+'？\')" href="javascript:void(0);" class="btn btn-sm btn-outline-primary mg-r-5 pd-b-5"><div><i class="fa fa-trash"></i>上架</div></a>';
				}else {
					html += '<a onclick="deleteAndRecoveryById(1,'+rowData.line_id+',\'bureau/line/recovery\',\'确定要下架线路---'+rowData.line_name+'？\')" href="javascript:void(0);" class="btn btn-sm btn-outline-primary mg-r-5 pd-b-5"><div><i class="fa fa-trash"></i>下架</div></a>';
				}
				return html;
        	}
        }	
