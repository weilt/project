...
$(function(){
	...
	// 请求地址
	_settings.ro_requestUrl = "bureau/order/query";
	// 排序设置
...
//        },
        ...
        {title:'操作', customHtml:
        	...
        	function(rowData,index){
				...
				html += '<a onclick="order_details('+rowData.order_id+',\'bureau/order/details\',\'订单详情\')" href="javascript:void(0);" class="btn btn-sm btn-outline-primary mg-r-5 pd-b-5"><div><i class="fa fa-pencil"></i>订单详情</div></a>';
				
				if (rowData.status==1){
					html += '<a onclick="order_confirm('+rowData.order_id+',\'bureau/order/confirm\')" href="javascript:void(0);" class="btn btn-sm btn-outline-primary mg-r-5 pd-b-5"><div><i class="fa fa-pencil"></i>确认订单</div></a>';
					html += '<a onclick="order_refuse('+rowData.order_id+',\'bureau/order/refuse\')" href="javascript:void(0);" class="btn btn-sm btn-outline-primary mg-r-5 pd-b-5"><div><i class="fa fa-pencil"></i>拒绝订单</div></a>';
				}
