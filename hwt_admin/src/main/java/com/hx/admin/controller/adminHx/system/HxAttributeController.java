...
public class HxAttributeController {
	 ...
	 * 跳转到轮播图分类
	 */
	@RequestMapping("adminHx/carousel_image/list")
	public ModelAndView carousel_image_list() {
		return new ModelAndView("adminHx/system/carousel_image/carousel_image-list");
	}

	/**
	 * 跳转到广告位置
	 */
	@RequestMapping("adminHx/advertising_position/list")
	public ModelAndView advertising_position_list() {
		return new ModelAndView("adminHx/system/advertising_position/advertising_position-list");
	}
	/**
	 * 查询
	 * @param pageSize
