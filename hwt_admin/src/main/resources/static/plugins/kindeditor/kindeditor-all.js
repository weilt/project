...
KindEditor.plugin('table', function(K) {
	...
	function _createCellIndex(table, row, cell) {
		var rowSpanCount = 0;
	...
	self.plugin.table = {
		...
		colinsert : function(offset) {
			...
			for (var i = 0, len = table.rows.length; i < len; i++) {
				...
				index = _createCellIndex(table, newRow, newCell);
			}
		...
		rowsplit : function() {
			...
			var cellIndex = _createCellIndex(table, row, cell);
			for (var i = 1, len = cell.rowSpan; i < len; i++) {
				...
				newCell.innerHTML = K.IE ? '' : '<br />';
				cellIndex = _createCellIndex(table, newRow, newCell);
			}
