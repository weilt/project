...
function ajaxCallback(data){
    data = strToJson(data)
        ...
        var  status0 = data.data.status0;
        $("#status0").text(status0);

        var  status1 = data.data.status1;
        $("#status1").text(status1);

        var  status2 = data.data.status2;
        $("#status2").text(status2);

        var  status3 = data.data.status3;
        $("#status3").text(status3);

        var  status4 = data.data.status4;
        $("#status4").text(status4);

        var  status5 = data.data.status5;
        $("#status5").text(status5);

        var  status6 = data.data.status6;
        $("#status6").text(status6);

        var  status7 = data.data.status7;
        $("#status7").text(status7);

        var  status8 = data.data.status8;
