 ...
 * @param dec
 */
function order_details2(order_id, url, dec) {
        ...
        success: function (res) {
            ...
            jsonState(res);
                ...
                var refund_time_back = hwOrderRefundVo.refund_time_back == null ? "":timestampToTime(hwOrderRefundVo.refund_time_back);
                    ...
                    if ((user_remarks == "" && business_remarks=="")||(user_remarks == null && business_remarks== null)){
                        refund_cause=hwOrderRefundVo.refund_cause == null ? "":hwOrderRefundVo.refund_cause;
                    }
                    if (refund_cause == ""){
                        refund_dec=hwOrderRefundVo.refund_dec == null ? "":hwOrderRefundVo.refund_dec;
                    }
                }else{
                    var wei = "";
                    var notWei = 'checked="checked"';
                ...
                switch (status) {
                    ...
                    case (4):
                        ...
                        break;
                    case (5):
                        if (business_remarks != "" && business_remarks == null) {
                            Status = "已退款"
                        } else {
                            Status = "已取消"
                        }
                ...
                _html += '<table id="z-zwz">                                                                                '
                    ...
                    + '</td>                                                                     '
                    + '<td id="tow">                                                                      '
                    + ''+business_remarks+'    '+user_remarks+'    '+refund_cause+'    '+refund_dec+'                                                      '
                    + '</td>                                                                      '
                    + '</tr>                                                                      '
                    + '</table>                          '
                    + '<table id="z-break">                          '
