...
$(function(){
	...
	_settings.ro_columns =  [
        ...
        {title:'操作', customHtml:
        	...
        	function(rowData,index){
				var html = '';
				html += '<a onclick="versionInfo('+rowData.id+',\'adminHx/version/versionInfo\',\'版本管理-查看（'+rowData.version_number+'）\')" href="javascript:void(0);" class="btn btn-sm btn-outline-primary mg-r-5 pd-b-5"><div><i class="fa fa-pencil"></i>查看详情</div></a>';
