	...
	$.ajax({
        ...
        success : function (res) {
        	res = strToJson(res);
            	...
            	+'               <div class="col-lg mg-l-10">                                                                                                                   '
            	+'    	           <a href="javascript:void(0);" onclick="catImage(\''+identity_positive+'\')"><img src="'+identity_positive+'" id="identity_positive" height="80px" width="80px"/></a>                                                               '
            	+'    	       </div>                                                                                                                                           '
            	+'            </div>                                                                                                                                            '
            	+' 			<div class="row mg-t-20">                                                                                                                           '
            	...
            	+'                 <div class="col-lg mg-l-10">                                                                                                                 '
            	+'    	           <a href="javascript:void(0);" onclick="catImage(\''+identity_negative+'\')"><img src="'+identity_negative+'" id="identity_negative" height="80px" width="80px"/></a>                                                               '
            	+'    	       </div>                                                                                                                                           '
            	+'            </div>                                                                                                                                            '
            	+'            <div class="row mg-t-20">                                                                                                                         '
            	...
            	+'                <div class="col-lg mg-l-10">                                                                                                                  '
            	+'    	           <a href="javascript:void(0);" onclick="catImage(\''+identity_hold+'\')"><img src="'+identity_hold+'" id="identity_hold" height="80px" width="80px"/></a>                                                                   '
            	+'    	       </div>                                                                                                                                           '
            	+'            </div>                                                                                                                                            '
            	...
            	if (cover!=""){
            		_html+='            <div class="row mg-t-20">                                                                                                                         '
            			...
            			+'                <div class="col-lg mg-l-10">                                                                                                                   '
                    	+'    	           <a href="javascript:void(0);" onclick="catImage(\''+cover+'\')"><img src="'+cover+'" id="cover" height="80px" width="80px"/></a>                                                               '
                    	+'    	       </div>   ' 
            			+'            </div> '         
            	}
            	if (autograph!=""){
