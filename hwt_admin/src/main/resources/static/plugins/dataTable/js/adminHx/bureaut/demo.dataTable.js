...
//        },
        ...
        {title:'操作', customHtml:
        	...
        	function(rowData,index){
	        	var html = '';
				html += '<a onclick="bureau_info('+rowData.bureau_id+',\'adminHx/bureaut/info\',\'旅行社资料-查看（'+rowData.company_name+'）\')" href="javascript:void(0);" class="btn btn-sm btn-outline-primary mg-r-5 pd-b-5"><div><i class="fa fa-pencil"></i>旅行社资料</div></a>';
//				if (rowData.status==2){
