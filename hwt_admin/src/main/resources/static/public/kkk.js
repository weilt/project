var E3 = {  
    ...
    kingEditorParams : {  
        ...
        //指定上传文件请求的url。  
        uploadJson : '/pic/upload/ScenicSpot',  
                    ...
                    editor.plugin.multiImageDialog({  
                        clickFn : function(urlList) {  
                            ...
                            KindEditor.each(urlList, function(i, data) {  
                                ...
                                var imageHtml = "";
                                imageHtml +='<div class="div"><a href="javascript:void(0);" onclick="catImage(\''+data.url+'\')"><img class="imgbox" src="'+data.url+'" /></a>'
                                ...
                                form.find("#bigbox").append(imageHtml);	
                            });  
