var E3 = {  
    ...
    kingEditorParams : {  
        ...
        //指定上传文件请求的url。  
        uploadJson : '/pic/upload/music_upload_img',
                    ...
                    editor.plugin.multiImageDialog({  
                        clickFn : function(urlList) {  
                            ...
                            KindEditor.each(urlList, function(i, data) {  
                                ...
                                var imageHtml = "";
                                imageHtml +='<div ><a href="javascript:void(0);" onclick="catImage(\''+data.url+'\')"><img class="imgbox" src="'+data.url+'" /></a>'
...
//						input.val(url);
//						$(input).next("i").html("<a href='"+url+"' target='_blank'><img src='"+url+"' width='80' height='50'/></a>");
                        $(_self).attr("src",url);
