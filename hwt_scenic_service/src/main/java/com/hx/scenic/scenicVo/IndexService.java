...
public interface IndexService {
     ...
     * @return	
     */
	List<Map<String, Object>> search(String searchKey, Integer type, Integer pageIndex, Integer pageSize, String area_code);
	 ...
	 * @return
	 */
	Map<String, Object> indexNew(String area_code, Integer pageIndex);
